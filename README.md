...
A colloquial question like *"what if someone beats me?"* is expanded into variants like *"assault causing hurt grievous hurt"* and *"BNS section punishment for beats"* before searching.  This catches sections that use legal terminology the user didn't know.
